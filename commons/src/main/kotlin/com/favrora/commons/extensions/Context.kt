...
import com.favrora.commons.models.AlarmSound
import com.favrora.commons.models.BlockedNumber
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.favrora.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.favrora.thankyou")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.favrora."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.favrora.contacts") && !packageName.startsWith("com.favrora.dialer")) {
        true
    } else if ((packageName.startsWith("com.favrora.contacts") || packageName.startsWith("com.favrora.dialer")) && isQPlus()) {
