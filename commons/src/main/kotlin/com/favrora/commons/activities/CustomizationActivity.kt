...
import com.favrora.commons.models.MyTheme
import com.favrora.commons.models.RadioItem
import com.favrora.commons.models.SharedTheme
import com.favrora.commons.views.MyTextView
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupOptionsMenu()
        refreshMenuItems()
        isThankYou = packageName.removeSuffix(".debug") == "com.favrora.thankyou"
        initColorVariables()
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.favrora.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
