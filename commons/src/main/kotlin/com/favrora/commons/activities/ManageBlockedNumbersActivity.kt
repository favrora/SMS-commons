package com.favrora.commons.activities
...
import com.favrora.commons.adapters.ManageBlockedNumbersAdapter
import com.favrora.commons.dialogs.AddBlockedNumberDialog
import com.favrora.commons.dialogs.ExportBlockedNumbersDialog
...
import com.favrora.commons.helpers.BlockedNumbersExporter.ExportResult
import com.favrora.commons.interfaces.RefreshRecyclerViewListener
...
class ManageBlockedNumbersActivity : BaseSimpleActivity(), RefreshRecyclerViewListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val blockTitleRes = if (baseConfig.appId.startsWith("com.favrora.dialer")) R.string.block_unknown_calls else R.string.block_unknown_messages
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.favrora.dialer")) {
