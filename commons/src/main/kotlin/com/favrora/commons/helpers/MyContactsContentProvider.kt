package com.favrora.commons.helpers
...
import com.favrora.commons.extensions.getIntValue
import com.favrora.commons.extensions.getStringValue
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.favrora.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.favrora.dialer" && packageName != "com.favrora.smsmessenger" && packageName != "com.favrora.calendar.pro") {
                return contacts
            }
